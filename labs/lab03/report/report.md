...
1. В соответствующем каталоге сделайте отчёт по лабораторной работе No 2
...
| `/etc`       | Общесистемные конфигурационные файлы и файлы конфигурации установленных программ                                           |iteproc: citation robbins:2013:bash not found
...
![4](image/4.png){ #fig:004 width=95% } 
